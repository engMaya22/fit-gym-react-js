                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2">
                  {
                    ['reps','rest','tempo'].map(info => {
                      return(
                              <div key={info} className="rounded border-[1.5px] flex flex-col p-2 mt-2 w-full border-solid border-slate-900">
                  ...
                  <button onClick={handleSetIncrement} className="flex flex-col p-2 mt-2 rounded border-[1.5px] duration-200 border-solid border-blue-900 hover:border-blue-600 w-full">
